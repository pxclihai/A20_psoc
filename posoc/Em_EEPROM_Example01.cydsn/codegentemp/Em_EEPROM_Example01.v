...
// SW_Tx_UART_v1_40(BaudRate=115200, PinAssignmentMethod=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_40, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SW_Tx_UART, CY_INSTANCE_SHORT_NAME=SW_Tx_UART, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=SW_Tx_UART, )
module SW_Tx_UART_v1_40_0 ;
