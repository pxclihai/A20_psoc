...
extern const uint8 CYCODE USBFS_1_SN_STRING_DESCRIPTOR[2];
extern const uint8 CYCODE USBFS_1_STRING_DESCRIPTORS[61u];
...
extern const uint8 CYCODE USBFS_1_HIDREPORT_DESCRIPTOR1[58u];
extern const uint8 CYCODE USBFS_1_HIDREPORT_DESCRIPTOR2[54u];
