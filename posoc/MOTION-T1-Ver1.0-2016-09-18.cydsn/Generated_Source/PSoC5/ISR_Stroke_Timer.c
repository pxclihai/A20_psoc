...
{
    #ifdef ISR_Stroke_Timer_INTERRUPT_INTERRUPT_CALLBACK
        ISR_Stroke_Timer_Interrupt_InterruptCallback();
    #endif /* ISR_Stroke_Timer_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling ISR_Stroke_Timer_Start or ISR_Stroke_Timer_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ISR_Stroke_Timer_Start or ISR_Stroke_Timer_StartEx has been called. 
