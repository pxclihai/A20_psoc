...
*
* Global variables:
*  I2CM_Address  - used to store I2C slave address for the primary
...
*
* Global variables:
*  I2CM_slRdBufPtr   - used to store pointer to slave read buffer.
*  I2CM_slRdBufSize  - used to store salve read buffer size.
     ...
     
{
    ...
    if(NULL != rdBuf)
    {
        I2CM_slRdBufPtr   = (volatile uint8 *) rdBuf;    /* Set buffer pointer */
...
*
* Global variables:
*  I2CM_slWrBufPtr   - used to store pointer to slave write buffer.
*  I2CM_slWrBufSize  - used to store salve write buffer size.
     ...
     
{
    ...
    if(NULL != wrBuf)
    {
        I2CM_slWrBufPtr   = (volatile uint8 *) wrBuf;  /* Set buffer pointer */
