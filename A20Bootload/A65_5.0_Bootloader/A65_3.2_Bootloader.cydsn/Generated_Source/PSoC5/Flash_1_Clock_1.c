...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_Start
********************************************************************************
*
* Summary:
...
void Flash_1_Clock_1_Start(void) 
{
    ...
    Flash_1_Clock_1_CLKEN |= Flash_1_Clock_1_CLKEN_MASK;
	Flash_1_Clock_1_CLKSTBY |= Flash_1_Clock_1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_Stop
********************************************************************************
*
* Summary:
...
void Flash_1_Clock_1_Stop(void) 
{
    ...
    Flash_1_Clock_1_CLKEN &= (uint8)(~Flash_1_Clock_1_CLKEN_MASK);
	Flash_1_Clock_1_CLKSTBY &= (uint8)(~Flash_1_Clock_1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Flash_1_Clock_1_CLKEN & Flash_1_Clock_1_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Flash_1_Clock_1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Flash_1_Clock_1_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Flash_1_Clock_1__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Flash_1_Clock_1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Flash_1_Clock_1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Flash_1_Clock_1_GetSourceRegister();
    uint16 oldDivider = Flash_1_Clock_1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Flash_1_Clock_1_CLKEN & Flash_1_Clock_1_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Flash_1_Clock_1_DIV_PTR, clkDivider);
                Flash_1_Clock_1_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Flash_1_Clock_1_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Flash_1_Clock_1_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Flash_1_Clock_1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Flash_1_Clock_1_DIV_PTR);
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Flash_1_Clock_1_MOD_SRC |= modeBitMask & (uint8)Flash_1_Clock_1_MODE_MASK;
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Flash_1_Clock_1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Flash_1_Clock_1_MODE_MASK));
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Flash_1_Clock_1_MOD_SRC & (uint8)(Flash_1_Clock_1_MODE_MASK);
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Flash_1_Clock_1_GetDividerRegister();
    uint8 oldSrc = Flash_1_Clock_1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Flash_1_Clock_1_MOD_SRC |= CYCLK_SSS;
        Flash_1_Clock_1_MOD_SRC =
            (Flash_1_Clock_1_MOD_SRC & (uint8)(~Flash_1_Clock_1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Flash_1_Clock_1_MOD_SRC & Flash_1_Clock_1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Flash_1_Clock_1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Flash_1_Clock_1_PHASE = clkPhase & Flash_1_Clock_1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Flash_1_Clock_1_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Flash_1_Clock_1_PHASE & Flash_1_Clock_1_PHASE_MASK;
}
