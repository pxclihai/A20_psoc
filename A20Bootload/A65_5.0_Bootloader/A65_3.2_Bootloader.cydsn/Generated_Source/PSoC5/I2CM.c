...
void I2CM_Init(void) 
{
        ...
        #if(CY_PSOC5A)
            I2CM_CLKDIV_REG  = LO8(I2CM_DEFAULT_DIVIDE_FACTOR);
        #else
        ...
        I2CM_CFG_REG      = I2CM_DEFAULT_CFG;      /* control  */
        I2CM_INT_MASK_REG = I2CM_DEFAULT_INT_MASK; /* int_mask */

        /* Enable interrupts from block */
        enableInterrupts = CyEnterCriticalSection();
        I2CM_INT_ENABLE_REG |= I2CM_INTR_ENABLE; /* aux_ctl */
    ...
    I2CM_state = I2CM_SM_IDLE;
        ...
        I2CM_slStatus = 0u; /* Reset slave status */
...
void I2CM_Enable(void) 
{
        ...
        CyExitCriticalSection(enableInterrupts);
            ...
            enableInterrupts = CyEnterCriticalSection();
            I2CM_COUNTER_AUX_CTL_REG |= I2CM_CNT7_ENABLE;   /* aux_ctl */
            CyExitCriticalSection(enableInterrupts);
        #endif /* (I2CM_MODE_SLAVE_ENABLED) */
...
{
    #if((I2CM_FF_IMPLEMENTED)  || \
        (I2CM_UDB_IMPLEMENTED && I2CM_MODE_SLAVE_ENABLED))
        uint8 enableInterrupts;
    #endif /* ((I2CM_FF_IMPLEMENTED)  || \
               (I2CM_UDB_IMPLEMENTED && I2CM_MODE_SLAVE_ENABLED)) */
    ...
    I2CM_DISABLE_INT_ON_STOP;   /* Interrupt on Stop can be enabled by write */
    (void) I2CM_CSR_REG;        /* Clear CSR reg */
    ...
    I2CM_ClearPendingInt();  /* Clear interrupt triggers on reset */

    I2CM_state = I2CM_SM_IDLE;  /* Reset software FSM */
}
