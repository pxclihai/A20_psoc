...
#define Counter_2_INIT_PERIOD_VALUE       1000u
#define Counter_2_INIT_COUNTER_VALUE      1000u
#if (Counter_2_UsingFixedFunction)
#define Counter_2_INIT_INTERRUPTS_MASK    ((uint8)((uint8)1u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
 ...
 *************************************/
    ...
    ********************************/
    ...
    #define Counter_2_STATUS               (* (reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define Counter_2_STATUS_PTR           (  (reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_REG )
    #define Counter_2_STATUS_MASK          (* (reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__MASK_REG )
    #define Counter_2_STATUS_MASK_PTR      (  (reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__MASK_REG )
    #define Counter_2_STATUS_AUX_CTRL      (*(reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define Counter_2_STATUS_AUX_CTRL_PTR  ( (reg8 *) Counter_2_CounterUDB_sSTSReg_rstSts_stsreg__STATUS_AUX_CTL_REG)
    #define Counter_2_CONTROL              (* (reg8 *) Counter_2_CounterUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
    #define Counter_2_CONTROL_PTR          (  (reg8 *) Counter_2_CounterUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
