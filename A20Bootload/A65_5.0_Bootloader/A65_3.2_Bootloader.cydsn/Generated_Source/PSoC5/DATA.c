...
void DATA_SetDriveMode(uint8 mode) 
{
	...
	CyPins_SetPinDriveMode(DATA_1, mode);
	CyPins_SetPinDriveMode(DATA_2, mode);
	CyPins_SetPinDriveMode(DATA_3, mode);
	CyPins_SetPinDriveMode(DATA_4, mode);
	CyPins_SetPinDriveMode(DATA_5, mode);
	CyPins_SetPinDriveMode(DATA_6, mode);
	CyPins_SetPinDriveMode(DATA_7, mode);
}
