...
{
    uint8 staticBits = (OUT_3_DR & (uint8)(~OUT_3_MASK));
    OUT_3_DR = staticBits | ((uint8)(value << OUT_3_SHIFT) & OUT_3_MASK);
}
...
{
	CyPins_SetPinDriveMode(OUT_3_0, mode);
}
...
{
    return (OUT_3_PS & OUT_3_MASK) >> OUT_3_SHIFT;
}
...
{
    return (OUT_3_DR & OUT_3_MASK) >> OUT_3_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (OUT_3_INTSTAT & OUT_3_MASK) >> OUT_3_SHIFT;
    }
