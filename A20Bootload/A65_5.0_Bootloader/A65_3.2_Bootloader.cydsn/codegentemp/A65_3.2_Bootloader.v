// ======================================================================
// A65_3.2_Bootloader.v generated from TopDesign.cysch
// 07/19/2016 at 17:02
...
module top ;
	...
	wire [0:0] tmpOE__Key_SCL_net;
	wire [0:0] tmpFB_0__Key_SCL_net;
	wire [0:0] tmpINTERRUPT_0__Key_SCL_net;
	electrical [0:0] tmpSIOVREF__Key_SCL_net;

	cy_psoc3_pins_v1_10
		#(.id("6441d17a-3ccc-4fe9-9d2e-1df17ebe6b72"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Key_SCL
		 (.oe(tmpOE__Key_SCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Key_SCL_net[0:0]}),
		  .io({Net_1401}),
		  .siovref(tmpSIOVREF__Key_SCL_net),
		  .interrupt({tmpINTERRUPT_0__Key_SCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Key_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Key_SDA_net;
	wire [0:0] tmpFB_0__Key_SDA_net;
	wire [0:0] tmpINTERRUPT_0__Key_SDA_net;
	electrical [0:0] tmpSIOVREF__Key_SDA_net;

	cy_psoc3_pins_v1_10
		#(.id("b6d4fa44-99da-4c90-8b73-fd265fc3536b"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Key_SDA
		 (.oe(tmpOE__Key_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Key_SDA_net[0:0]}),
		  .io({Net_1402}),
		  .siovref(tmpSIOVREF__Key_SDA_net),
		  .interrupt({tmpINTERRUPT_0__Key_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Key_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Stop_net;
	wire [0:0] tmpFB_0__Pin_Stop_net;
	wire [0:0] tmpIO_0__Pin_Stop_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Stop_net;
	electrical [0:0] tmpSIOVREF__Pin_Stop_net;

	cy_psoc3_pins_v1_10
		#(.id("e4198f89-27fb-4408-84be-5a74f945892a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_Stop_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Run_net;
	wire [0:0] tmpFB_0__Pin_Run_net;
	wire [0:0] tmpIO_0__Pin_Run_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Run_net;
	electrical [0:0] tmpSIOVREF__Pin_Run_net;

	cy_psoc3_pins_v1_10
		#(.id("5717bea3-1926-468d-88bb-17049d47d9e2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Run
		 (.oe(tmpOE__Pin_Run_net),
		  .y({Net_826}),
		  .fb({tmpFB_0__Pin_Run_net[0:0]}),
		  .io({tmpIO_0__Pin_Run_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Run_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Run_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Run_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_367 or Net_1404 or Net_370)
        begin
            case (Net_370)
                1'b0 :  tmp__mux_2_reg = Net_367;
                1'b1 :  tmp__mux_2_reg = Net_1404;
            endcase
        end
        assign Net_826 = tmp__mux_2_reg;
    end
    // -- Mux end --
	...
	cy_psoc3_pins_v1_10
		#(.id("a1fd285e-a89d-4051-9724-562badecf28f"),
	...
	assign tmpOE__DATA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("2bf666d1-ad64-4543-b78a-6cf3a5cabfb8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RD_net;
	wire [0:0] tmpFB_0__RD_net;
	wire [0:0] tmpIO_0__RD_net;
	wire [0:0] tmpINTERRUPT_0__RD_net;
	electrical [0:0] tmpSIOVREF__RD_net;

	cy_psoc3_pins_v1_10
		#(.id("de557ad2-c08a-48fc-a6dd-f9ce59352cda"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RD
		 (.oe(tmpOE__RD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RD_net[0:0]}),
		  .io({tmpIO_0__RD_net[0:0]}),
		  .siovref(tmpSIOVREF__RD_net),
		  .interrupt({tmpINTERRUPT_0__RD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WR_net;
	wire [0:0] tmpFB_0__WR_net;
	wire [0:0] tmpIO_0__WR_net;
	wire [0:0] tmpINTERRUPT_0__WR_net;
	electrical [0:0] tmpSIOVREF__WR_net;

	cy_psoc3_pins_v1_10
		#(.id("743d8741-f9a7-4dfa-bf51-a92114ed361d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		WR
		 (.oe(tmpOE__WR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WR_net[0:0]}),
		  .io({tmpIO_0__WR_net[0:0]}),
		  .siovref(tmpSIOVREF__WR_net),
		  .interrupt({tmpINTERRUPT_0__WR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("cc462c5b-4a80-4faf-a62a-4561b7100262"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("928b9951-3576-496f-9c90-ee4d11c37307"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
