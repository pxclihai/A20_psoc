...
void Bootloader_1_Start(void) CYSMALL 
{
    ...
    /* Identify active bootloadable application */
        ...
        if(Bootloader_1_GetMetadata(Bootloader_1_GET_BTLDB_ACTIVE, 0u) == Bootloader_1_MD_BTLDB_IS_ACTIVE)
        {
            /*******************************************************************
            * -----------------------------------------------------------
            ...
            *******************************************************************/
            ...
            {
                if (CYRET_SUCCESS == Bootloader_1_ValidateBootloadable(Bootloader_1_MD_BTLDB_ACTIVE_1))
                {
                    /* Cases # 10 and 12 */
...
*  Bootloader_1_EXIT_TO_BTLDR   - Bootloader application will be started on
*                                     software reset.
...
void Bootloader_1_Exit(uint8 appId) CYSMALL 
{
    ...
    {
        Bootloader_1_SET_RUN_TYPE(0x0u);
    }
    else
    {
...
void CyBtldr_CheckLaunch(void) CYSMALL 
{
    ...
    *******************************************************************************/
    ...
    if (Bootloader_1_GET_RUN_TYPE == Bootloader_1_START_APP)
    {
        ...
        *******************************************************************************/
        if(0u != Bootloader_1_GetMetadata(Bootloader_1_GET_BTLDB_ADDR, Bootloader_1_activeApp))
        {
...
cystatus Bootloader_1_ValidateBootloadable(uint8 appId) CYSMALL \

    {
        ...
        uint32 CYDATA end   = Bootloader_1_FIRST_APP_BYTE(appId) +
                                Bootloader_1_GetMetadata(Bootloader_1_GET_BTLDB_LENGTH,
                                                       appId);
    ...
    do
    {
        ...
        if(ackCode == CYRET_SUCCESS)
        {
                    ...
                    if((Bootloader_1_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 1u))
                    {
                        ...
                        else if(CYRET_SUCCESS == Bootloader_1_ValidateBootloadable(btldrData))
                        {
                                ...
                                (void) memcpy(&packetBuffer[Bootloader_1_DATA_ADDR],
                                            ((uint8  CYCODE *) (Bootloader_1_META_BASE(btldrData))),
                                            Bootloader_1_GET_METADATA_RESPONSE_SIZE);
                            #else
                                (void) memcpy(&packetBuffer[Bootloader_1_DATA_ADDR],
                                            (uint8 *) Bootloader_1_META_BASE(btldrData),
                                            Bootloader_1_GET_METADATA_RESPONSE_SIZE);
                            #endif  /* (CY_PSOC3) */
            ...
            ***************************************************************************/
            ...
            /* Replace Bootloader_1_NUM_OF_FLASH_ARRAYS with CY_FLASH_NUMBER_ARRAYS */
                        ...
                        *******************************************************************************/
                        ...
                        if(row < firstRow)
                        {
                            ...
                            if(Bootloader_1_activeApp < Bootloader_1_MD_BTLDB_ACTIVE_NONE)
                            {
                                ...
                                *******************************************************************************/
                                firstRow = (uint16) 1u +
                                    (uint16) Bootloader_1_GetMetadata(Bootloader_1_GET_BTLDR_LAST_ROW,
                                                                          Bootloader_1_activeApp);
                                ...
                                *******************************************************************************/
                                lastRow = (uint16)(CY_FLASH_NUMBER_ROWS -
                                                    Bootloader_1_NUMBER_OF_METADATA_ROWS -
                                                    firstRow);
                                ...
                                *******************************************************************************/
                                lastRow = lastRow / (Bootloader_1_NUMBER_OF_BTLDBLE_APPS -
                                                Bootloader_1_activeApp);
            ...
            *   Verify row
            ***************************************************************************/
            #if (0u != Bootloader_1_CMD_VERIFY_ROW_AVAIL)
            ...
            case Bootloader_1_COMMAND_VERIFY:
                ...
                if((Bootloader_1_COMMUNICATION_STATE_ACTIVE == communicationState) && (pktSize == 3u))
                {
                    ...
                    uint16 CYDATA rowNum = ((uint16)((uint16)packetBuffer[Bootloader_1_DATA_ADDR + 2u] << 8u)) |
                        ...
                        uint8 CYDATA checksum = Bootloader_1_Calc8BitSum(CY_FLASH_BASE,
                                                                             rowAddr,
                                                                             CYDEV_FLS_ROW_SIZE);
                    ...
                    * correct.
                       ...
                       (Bootloader_1_CONTAIN_METADATA(rowNum)))
                    {
                        ...
                        checksum -= (uint8)Bootloader_1_GetMetadata(Bootloader_1_GET_BTLDB_ACTIVE,
                                                                 Bootloader_1_GET_APP_ID(rowNum));
            ...
            #endif /* (0u != Bootloader_1_CMD_VERIFY_ROW_AVAIL) */
...
*   Bootloader_1_GET_BTLDB_CHECKSUM    - Bootloadable Application Checksum
*   Bootloader_1_GET_BTLDB_ADDR        - Bootloadable Application Start
*                                            Routine Address
*   Bootloader_1_GET_BTLDR_LAST_ROW    - Bootloader Last Flash Row
*   Bootloader_1_GET_BTLDB_LENGTH      - Bootloadable Application Length
*   Bootloader_1_GET_BTLDB_ACTIVE      - Active Bootloadable Application
*   Bootloader_1_GET_BTLDB_STATUS      - Bootloadable Application
*                                            Verification Status
*   Bootloader_1_GET_BTLDR_APP_VERSION - Bootloader Application Version
*   Bootloader_1_GET_BTLDB_APP_VERSION - Bootloadable Application Version
*   Bootloader_1_GET_BTLDB_APP_ID      - Bootloadable Application ID
*   Bootloader_1_GET_BTLDB_APP_CUST_ID - Bootloadable Application Custom ID
*
*  appId:
