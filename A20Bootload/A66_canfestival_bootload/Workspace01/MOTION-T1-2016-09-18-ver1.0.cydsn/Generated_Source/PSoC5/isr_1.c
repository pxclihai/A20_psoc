...
CY_ISR(isr_1_Interrupt)
{
    ...
    switch(time_count)
    {
//       case 0: LCD_Char_1_Position(1,0) ; LCD_Char_1_PrintString("0 S");break;
//       case 1: LCD_Char_1_Position(1,0) ; LCD_Char_1_PrintString("1 S");break;
//       case 2: LCD_Char_1_Position(1,0) ; LCD_Char_1_PrintString("2 S");break;
//       case 3: LCD_Char_1_Position(1,0) ; LCD_Char_1_PrintString("3 S");break;
    }
//    time_count--;
    /* `#END` */
}
